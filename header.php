			...
			<div class="row cells5">
				<div class="cell">
					...
					<ul class="v-menu" style="border:1px solid blue">
						...
						<li><a href="datasiswa.php"><span class="mif-user icon"></span> Data Siswa</a></li>
						<li><a href="alternatif.php"><span class="mif-stack icon"></span> Alternatif Guru</a></li>
						<li><a href="perangkingan.php"><span class="mif-books icon"></span> Penilaian Siswa</a></li>
						<li><a target="_blank" href="laporan.php"><span class="mif-file-pdf icon"></span> Laporan Penilaian</a></li>
						<li class="divider"></li>
